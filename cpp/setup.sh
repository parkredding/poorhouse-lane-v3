...
if [ "${NEEDS_REBOOT:-false}" = true ]; then
    ...
    echo -e "  ${CYAN}cd $CPP_DIR && bash setup.sh${NC}"
    echo ""
...
echo ""
echo "  Bank A: LFO Depth, Base Freq, Filter Freq, Delay FB, Reverb Mix"
echo "  Bank B: LFO Rate, Delay Time, Filter Res, Osc Wave, Reverb Size"
